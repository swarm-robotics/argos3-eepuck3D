...
namespace argos {
   ...
   CDynamics3DEPuckModel::CDynamics3DEPuckModel(CDynamics3DEngine& c_engine,
      ...
      /* SAnchor* psLeftWheelAnchor = &c_epuck.GetEmbodiedEntity().GetAnchor("left_wheel"); */
      /* SAnchor* psRightWheelAnchor = &c_epuck.GetEmbodiedEntity().GetAnchor("right_wheel"); */
      /* SAnchor* psBodyAnchor = &c_epuck.GetEmbodiedEntity().GetAnchor("body"); */
      /* create the bodies */
   ...
   void CDynamics3DEPuckModel::UpdateEntityStatus() {
      ...
      printf("Updated entity status\n");
      printf("Entity position: %f,%f\n",
             GetEmbodiedEntity().GetOriginAnchor().Position.GetX(),
             GetEmbodiedEntity().GetOriginAnchor().Position.GetY());
   }
   ...
   void CDynamics3DEPuckModel::UpdateFromEntityStatus() {
      ...
      m_ptrLeftMotor->setVelocityTarget(m_cWheeledEntity.GetWheelVelocities()[0] * 10);
      m_ptrRightMotor->setVelocityTarget(m_cWheeledEntity.GetWheelVelocities()[1] * 10);
      printf("Updated velocities: R=%f/L=%f\n",
             m_cWheeledEntity.GetWheelVelocities()[0],
